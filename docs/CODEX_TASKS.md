...
- Keep mobile cache and playback smoke coverage green during auth work.
...
- Added route manifest refresh controls for cached tours.
- Added cached manifest refresh status messaging after retry.
